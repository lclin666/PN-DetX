...
#        iou = bbox_iou_improve(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True, Focal=False)
        iou = bbox_iou_improve(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=True, CIoU=False, Focal=True, alpha=1)
